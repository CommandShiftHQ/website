---
title: "Walkthrough: Routing"
---

### List of tasks
1. Add `react-router-dom` to your project's dependencies.

2. Wrap the [`<BrowserRouter />`](https://reactrouter.com/en/main/router-components/browser-router) component around your `<App />` component.
...
2. Wrap the `<BrowserRouter />` component around your `<App />` component.
