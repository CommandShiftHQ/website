...
To do this you will need to get familiar with the following: 
 ...
 - Reading 📖: [The CREATE Keyword](https://www.tutorialspoint.com/postgresql/postgresql_create_table.htm)
 - Reading 📖: [PostgreSQL Data Types](https://www.tutorialspoint.com/postgresql/postgresql_data_types.htm)
 - Reading 📖: [PostgreSQL Constraints](https://www.tutorialspoint.com/postgresql/postgresql_constraints.htm)
