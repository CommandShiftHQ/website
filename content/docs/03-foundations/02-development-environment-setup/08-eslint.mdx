...
3. Click on the extensions icon in the right-side toolbar:
   ...
   ![VS Code Extensions Icon](https://s3.eu-west-2.amazonaws.com/mcrcodes/precourse-images/vscode-extensions.png)

4. In the search box, type **ESLint** and click Install (in green) on the top result:

   ![VS Code Extensions Search](https://s3.eu-west-2.amazonaws.com/mcrcodes/precourse-images/vscode-extensions-search.png)
