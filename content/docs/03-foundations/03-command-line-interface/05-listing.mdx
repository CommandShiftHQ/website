...
![List of files](https://s3.eu-west-2.amazonaws.com/mcrcodes/precourse-images/cli/3-ls.png)
...
![Long format](https://s3.eu-west-2.amazonaws.com/mcrcodes/precourse-images/cli/4-ls-long.png)
